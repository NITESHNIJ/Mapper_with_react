                ...
                return (
                        <div class="card" style={{margin: "20px"}}>
                            ...
                            <div class="card-body">
                                ...
                                {console.log(`/map_with_id/${map._id}`)}
                                <a onClick={() => {props.clickit(`/map_with_id/${map._id}`)}} style={{color: 'white',cursor:'pointer'}} class="btn btn-primary">View</a>
                            </div>
                        </div>
                );
            });
...
class ViewCustomMaps extends Component{
    constructor(props){
        super(props);
        this.state = {
            maps: null
